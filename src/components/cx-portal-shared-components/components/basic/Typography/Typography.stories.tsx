...
export const Base = () => (
  <>
    ...
    <Typography variant="body1">
      Body 1 Lorem ipsum dolor sit, amet consectetur adipisicing elit. Veritatis maiores quod saepe quos officiis.
      Fugiat mollitia sunt, praesentium possimus iusto soluta error placeat veniam nisi cum itaque voluptas sequi
      reprehenderit?
    </Typography>
    <Typography variant="body2">
      Body 2 Lorem ipsum dolor sit, amet consectetur adipisicing elit. Veritatis maiores quod saepe quos officiis.
      Fugiat mollitia sunt, praesentium possimus iusto soluta error placeat veniam nisi cum itaque voluptas sequi
      reprehenderit?
    </Typography>
    <Typography variant="body3">
      Body 3 Lorem ipsum dolor sit amet, consectetur adipisicing elit. Illum ut laborum non labore iure harum minus
      velit, necessitatibus sunt vero, dolore aut maiores repudiandae! Quibusdam, nihil? Ab molestiae sint labore!
    </Typography>
