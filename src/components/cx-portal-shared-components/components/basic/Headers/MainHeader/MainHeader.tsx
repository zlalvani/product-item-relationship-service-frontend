  ...
  return (
    <Box
      sx={{
        ...
        position: "relative",
        background: `linear-gradient(${backgroundstyle().direction}deg, ${backgroundstyle().colorFrom}, ${
    ...
    >
      ...
      >
        <MainHeaderTitle title={title} subTitle={subTitle} subTitleWidth={subTitleWidth} />
