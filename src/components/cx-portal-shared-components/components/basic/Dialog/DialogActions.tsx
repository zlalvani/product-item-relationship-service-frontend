...
export const DialogActions = ({ children, helperText, ...props }: DialogActionProps) => {
  ...
  return (
    ...
    >
      {helperText && <Box sx={{ paddingBottom: 4, typography: "body3", textAlign: "center" }}>{helperText}</Box>}
