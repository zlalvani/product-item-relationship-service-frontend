...
export interface CardProps extends CardContentProps, CardButtonsProps, CardImageProps, CardChipProps {
    ...
    >
      ...
      >
        <Box>
          ...
          <CardImage image={image} imageSize={imageSize} imageShape={imageShape} preview={variant === "preview"} />
        </Box>
        <Box
          sx={{
            padding: 3,
